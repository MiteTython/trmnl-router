...
# route compression
ROUTE_CODES = {
"Yellow-S â€" Antioch to SF Int'l Airport SFO/Millbrae": "Y",
"Red-S â€" Richmond to SF Int'l Airport SFO/Millbrae": "R",
}

ROUTE_NAMES = {
"Y": "Yellow Antioch â†' SFO",
"R": "Red Richmond â†' SFO"
}
...
for e in feed.entity:
    ...
    line = f"{route.get('route_short_name')} â€" {route.get('route_long_name')}"
